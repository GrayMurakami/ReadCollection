...
<head>
  ...
  @vite(['resources/css/dashboard.css', 'resources/css/bookShow.css'])
</head>
...
<body class="d-flex flex-column min-vh-100">
  ...
  <header class="p-3 text-bg-dark">
    <div class="container mx-3">
      <div class="d-flex">
        ...
        <!-- ロゴ -->
        <a href="/bookManagerDashboard" class="my-4 mb-lg-0 text-white text-decoration-none bi me-3">
          <img src="{{asset ('storage/images/logo.bmp')}}" class="logoScaleRotate" alt="logoHeader" />
        </a>

        <!-- サイト名 -->
        <div class="d-flex align-self-center mb-5">
          <a href="/bookManagerDashboard" class="siteNameScale px-2 text-white fs-3 text-with-shadow ms-5 me-4">読書コレクション</a>
          <span class="ms-5 fs-2 fw-bold">書籍管理者</span>
        </div>
  ...
  <footer class="footer-dark d-flex flex-wrap justify-content-between align-items-center py-2 mt-4">
    ...
    <div class="container d-flex justify-content-between mx-n1">
      ...
      <li class="ms-3 nav justify-content-end d-flex mx-n5 mt-1">
        <a class="bi text-white customLink" href="/bookManagerDashboard/contact"> お問い合わせリンク
        </a>
      </li>
    </div>
  </footer>
